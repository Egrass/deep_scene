...
caffe_root = '/misc/lmbraid17/oliveira/caffe_Context_global/'  # this file is expected to be in {caffe_root}/examples
import sys
...
solver = caffe.SGDSolver('solverFCN32s.prototxt')
