...
im = Image.open('b332-003_Clipped.jpg')
im = im.resize((300,300),Image.ANTIALIAS)
in_ = np.array(im, dtype=np.float32)
in_ = in_[:,:,::-1]
in_ -= np.array((81.1208, 102.1851, 120.4470))
...
net = caffe.Net('fcn-32s-pascal-deploy_300.prototxt', 'FCN_32S_snapshot_iter_200000.caffemodel', caffe.TEST)
...
scipy.misc.imsave('b332-003_Clipped_FCN32s.jpg', out)
